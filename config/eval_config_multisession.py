...
eval_arg.add_argument(
    "--thresh_min", default=1.0, type=float, help="Thresholds on euclidean-distance."
)
eval_arg.add_argument(
    "--thresh_max", default=100.0, type=float, help="Thresholds on euclidean-distance."
)
eval_arg.add_argument(
    "--num_thresholds",
    default=100,
...
data_arg.add_argument(
    "--dataloader_ref", type=str, required=True, help="Dataloader name"
)
data_arg.add_argument(
    "--data_dir_ref", type=Path, required=True, help="Path to the dataset"
)
data_arg.add_argument("--sequence_ref", type=str, default=None, help="Sequence Name")
data_arg.add_argument(
    "--dataloader_query", type=str, required=True, help="Dataloader name"
)
data_arg.add_argument(
    "--data_dir_query", type=Path, required=True, help="Path to the dataset"
)
